        ...
        if($_GET['etat']=="true"){
          echo '
            ...
            echo '
              ...
              <script>
                 setTimeout(function(){
                    window.location.href = \'student_trait.php\';
                 }, 2000);
              </script>
              ';
            }else{
...
?>
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <?php 
                  if(isset($_GET['id'])){
                    echo '<form action="traitement/modify_student.php?id='.$id.'" method="POST" id="formajout">';
                  }else{
                    echo '<form action="traitement/add_student.php" method="POST" id="formajout">';
                  }
                ?>

...
if (isset($_POST['number'])) {
    ...
    echo'<form action="traitement/insertqst1.php" method="post">
        ...
        echo'<div class="card">
                ...
                <div class="card-body">
                 ...
                 <input type="text" style="margin: 10px;" name="question'.$i.'" class="form-control" id="exampleFormControlInput1" placeholder="Question">
                  ...
                  <input type="text" style="margin: 10px;" name="option_1'.$i.'" class="form-control" id="exampleFormControlInput1" placeholder="Reponse correcte">
                  ...
                  <p class="sup2"style="margin: 10px 10px 0px 10px;font-weight:Bold;color: green;padding-left:10px; font-size: 80%;text-align: left;"></i> Sélectionnez un fichier audio</p>
                  <input type="file" style="margin: 0px 10px 10px 10px;"name="audio_file'.$i.'" class="form-control" id="exampleFormControlInput1" accept="audio/*" placeholder="Sélectionnez un fichier audio">

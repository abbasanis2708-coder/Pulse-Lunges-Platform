  ...
  *****************************************/
...

  {
            ...
            /*traitement pour le login*/
                ...
                // D'abord, on essaie de récupérer l'admin par email
                $query1 = "SELECT id, name, password, date_of_birth from admin_ where email=?";
                ...
                if($result->rowCount()!=0){
                    ...
                    if(str_starts_with($row['password'], '$')) {
                        ...
                        if(password_verify($_POST['password'], $row['password'])) {
                            ...
                            $_SESSION['date_of_birth'] = test_input($row['date_of_birth']);
                            header("Location: ./amaster/dash/index.php");
                        } else {
                        ...
                        if($_POST['password'] === $row['password']) {
                            ...
                            $update_query = "UPDATE admin_ SET password = ? WHERE id = ?";
                            PDO($update_query, [$hashed_password, $row['id']]);

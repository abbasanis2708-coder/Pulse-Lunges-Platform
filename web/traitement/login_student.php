  ...
  *****************************************/
...

  {
            ...
            /*traitement pour le login*/
                ...
                // D'abord, on essaie de récupérer l'étudiant par email
                $query1 = "SELECT student_id, name, password from student where email=?";
                ...
                if($result->rowCount()!=0){
                    ...
                    if(str_starts_with($row['password'], '$')) {
                        ...
                        if($_POST['password'] === $row['password']) {
                            ...
                            $update_query = "UPDATE student SET password = ? WHERE student_id = ?";
                            PDO($update_query, [$hashed_password, $row['student_id']]);

...
**/
  ...
  include("traitement/login_admin.php");
...
<body>
	...
	<img class="wave" src="static/img/login/wave_admin.png">

	<div class="container">

		<div class="img">

			<img src="static/img/login/undraw_authentication_fsn5_admin.svg">
		...
		<div class="login-content">
			...
			<form action="" method="POST">
				...
				<img src="static/img/login/avatar_admin.svg">

				<h2 class="title">Bonjour admin</h2>
